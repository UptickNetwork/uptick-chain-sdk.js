 ...
 */
const methodDescriptor_Query_ConsensusStateHeights = new grpc.web.MethodDescriptor(
  '/ibc.core.client.v1.Query/ConsensusStateHeights',
  grpc.web.MethodType.UNARY,
  proto.ibc.core.client.v1.QueryConsensusStateHeightsRequest,
  proto.ibc.core.client.v1.QueryConsensusStateHeightsResponse,
  /**
   * @param {!proto.ibc.core.client.v1.QueryConsensusStateHeightsRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
...
/**
 * @param {!proto.ibc.core.client.v1.QueryConsensusStateHeightsRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.ibc.core.client.v1.QueryConsensusStateHeightsResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.ibc.core.client.v1.QueryConsensusStateHeightsResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.ibc.core.client.v1.QueryClient.prototype.consensusStateHeights =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/ibc.core.client.v1.Query/ConsensusStateHeights',
      request,
      metadata || {},
      methodDescriptor_Query_ConsensusStateHeights,
      callback);
};
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.ibc.core.client.v1.QueryConsensusStateHeightsResponse>}
 *     Promise that resolves to the response
 */
proto.ibc.core.client.v1.QueryPromiseClient.prototype.consensusStateHeights =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/ibc.core.client.v1.Query/ConsensusStateHeights',
      request,
