 ...
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.cosmos.upgrade.v1beta1.MsgSoftwareUpgradeResponse)}
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.cosmos.upgrade.v1beta1.MsgCancelUpgradeResponse)}
 *     callback The callback function(error, response)
