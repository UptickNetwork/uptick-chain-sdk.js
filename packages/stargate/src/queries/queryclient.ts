...
import { tendermint34, Tendermint37Client } from "@cosmjs/tendermint-rpc";
...
export class QueryClient {
  ...
  public static withExtensions(tmClient: Tendermint37Client): QueryClient;
  ...
  public constructor(tmClient: Tendermint37Client) {
